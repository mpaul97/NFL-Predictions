...
def buildQb():
	...
	pl = pd.read_csv("cQbData_78-21W20.csv")
	...
	pl.to_csv("cExtraQbData_78-21W20.csv", index=False)
...
def buildRw():
	...
	rd = pd.read_csv("cRbData_78-21W20.csv")
	wd = pd.read_csv("cWrData_78-21W20.csv")
	pl = pd.concat([rd, wd])
	...
	rbs.to_csv("cExtraRbData_78-21W20.csv", index=False)
	wrs.to_csv("cExtraWrData_78-21W20.csv", index=False)
	#END BUILDRW
