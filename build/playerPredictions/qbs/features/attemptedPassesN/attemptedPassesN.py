...
def buildAttemptedPassesN(n):
    ...
    for index, row in source.iterrows():
        ...
        if stats.empty:
            ...
            stats = stats['attempted_passes'].values
    ...
    df.to_csv("%s.csv" % ("attemptedPasses" + str(n)), index=False)

###############################

buildAttemptedPassesN(10)