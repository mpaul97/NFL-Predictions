...
def buildCompletedPassesN(n):
    ...
    for index, row in source.iterrows():
        ...
        if stats.empty:
            ...
            stats = stats['completed_passes'].values
    ...
    df.to_csv("%s.csv" % ("completedPasses" + str(n)), index=False)

###############################

buildCompletedPassesN(10)